-- Consolidated base schema for the attendance system.
-- Generated from the current database via SHOW CREATE TABLE.
-- Run this once against a fresh database to provision every table.
-- Schema only — contains no rows. Create an admin user separately
-- (see setAdminPassword.ts) and apply later changes via npm run migrate.
...
CREATE TABLE `auth_login_logs` (
  `login_log_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'รหัส log การ login ใช้เป็น Primary Key ของตารางบันทึกการเข้าใช้งาน',
  ...
  KEY `idx_auth_login_logs_login_method` (`login_method`),
  KEY `idx_auth_login_logs_login_status` (`login_status`),
  KEY `idx_auth_login_logs_created_at` (`created_at`),
  CONSTRAINT `fk_auth_login_logs_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Server-side session storage for cookie-based admin auth.';

-- ----- auth_sso_accounts -----
DROP TABLE IF EXISTS `auth_sso_accounts`;
CREATE TABLE `auth_sso_accounts` (
  `sso_account_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'รหัสบัญชี SSO ภายในระบบ ใช้เป็น Primary Key ของตารางเชื่อมบัญชี SSO',
  ...
  PRIMARY KEY (`sso_account_id`),
  UNIQUE KEY `uq_auth_sso_accounts_provider_subject` (`provider_code`,`provider_subject`),
  KEY `idx_auth_sso_accounts_user_id` (`user_id`),
  KEY `idx_auth_sso_accounts_provider_email` (`provider_email`),
  KEY `idx_auth_sso_accounts_deleted_at` (`deleted_at`),
  CONSTRAINT `fk_auth_sso_accounts_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `auth_users` (
  `user_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'รหัสผู้ใช้ภายในระบบ ใช้เป็น Primary Key ของตารางผู้ใช้',
  ...
  KEY `idx_auth_users_role_code` (`role_code`),
...
DROP TABLE IF EXISTS `email_notification_templates`;
CREATE TABLE `email_notification_templates` (
  `email_template_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'รหัสเทมเพลตอีเมล ใช้เป็น Primary Key ของตารางเทมเพลตการแจ้งเตือน',
  ...
  UNIQUE KEY `uq_email_notification_templates_form_id_notification_code` (`form_id`,`notification_code`),
  KEY `idx_email_notification_templates_is_active` (`is_active`),
  KEY `idx_email_notification_templates_deleted_at` (`deleted_at`),
  KEY `idx_email_notification_templates_created_by_user_id` (`created_by_user_id`),
  KEY `idx_email_notification_templates_updated_by_user_id` (`updated_by_user_id`),
  CONSTRAINT `fk_email_notification_templates_created_by_user_id` FOREIGN KEY (`created_by_user_id`) REFERENCES `auth_users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_email_notification_templates_form_id` FOREIGN KEY (`form_id`) REFERENCES `form_forms` (`form_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_email_notification_templates_updated_by_user_id` FOREIGN KEY (`updated_by_user_id`) REFERENCES `auth_users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `email_send_logs` (
  `email_log_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'รหัส log การส่งอีเมล ใช้เป็น Primary Key ของตารางบันทึกการส่งอีเมล',
  ...
  KEY `idx_email_send_logs_email_template_id` (`email_template_id`),
  KEY `idx_email_send_logs_form_id` (`form_id`),
  KEY `idx_email_send_logs_submission_id` (`submission_id`),
  KEY `idx_email_send_logs_recipient_email` (`recipient_email`),
  KEY `idx_email_send_logs_send_status` (`send_status`),
  KEY `idx_email_send_logs_sent_at` (`sent_at`),
  KEY `idx_email_send_logs_deleted_at` (`deleted_at`),
  CONSTRAINT `fk_email_send_logs_email_template_id` FOREIGN KEY (`email_template_id`) REFERENCES `email_notification_templates` (`email_template_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_email_send_logs_form_id` FOREIGN KEY (`form_id`) REFERENCES `form_forms` (`form_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_email_send_logs_submission_id` FOREIGN KEY (`submission_id`) REFERENCES `entry_submissions` (`submission_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `entry_submission_answer_options`;
CREATE TABLE `entry_submission_answer_options` (
  `answer_option_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'รหัสรายการตัวเลือกที่ถูกเลือก ใช้เป็น Primary Key ของตารางคำตอบแบบหลายตัวเลือก',
  ...
  UNIQUE KEY `uq_entry_submission_answer_options_answer_id_option_id` (`answer_id`,`option_id`),
  KEY `idx_entry_submission_answer_options_option_id` (`option_id`),
  KEY `idx_entry_submission_answer_options_deleted_at` (`deleted_at`),
  CONSTRAINT `fk_entry_submission_answer_options_answer_id` FOREIGN KEY (`answer_id`) REFERENCES `entry_submission_answers` (`answer_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_entry_submission_answer_options_option_id` FOREIGN KEY (`option_id`) REFERENCES `form_field_options` (`option_id`) ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `entry_submission_answers`;
CREATE TABLE `entry_submission_answers` (
  `answer_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'รหัสคำตอบ ใช้เป็น Primary Key ของตารางคำตอบรายฟิลด์',
  ...
  UNIQUE KEY `uq_entry_submission_answers_submission_id_field_id` (`submission_id`,`field_id`),
  KEY `idx_entry_submission_answers_field_id` (`field_id`),
  KEY `idx_entry_submission_answers_selected_option_id` (`selected_option_id`),
  KEY `idx_entry_submission_answers_deleted_at` (`deleted_at`),
  CONSTRAINT `fk_entry_submission_answers_field_id` FOREIGN KEY (`field_id`) REFERENCES `form_fields` (`field_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_entry_submission_answers_selected_option_id` FOREIGN KEY (`selected_option_id`) REFERENCES `form_field_options` (`option_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_entry_submission_answers_submission_id` FOREIGN KEY (`submission_id`) REFERENCES `entry_submissions` (`submission_id`) ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `entry_submission_files`;
CREATE TABLE `entry_submission_files` (
  `answer_file_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'รหัสไฟล์แนบของคำตอบ ใช้เป็น Primary Key ของตารางไฟล์ที่ผู้ใช้อัปโหลด',
  ...
  PRIMARY KEY (`answer_file_id`),
  KEY `idx_entry_submission_files_answer_id` (`answer_id`),
  KEY `idx_entry_submission_files_storage_disk` (`storage_disk`),
  KEY `idx_entry_submission_files_deleted_at` (`deleted_at`),
  CONSTRAINT `fk_entry_submission_files_answer_id` FOREIGN KEY (`answer_id`) REFERENCES `entry_submission_answers` (`answer_id`) ON UPDATE CASCADE
...
-- ----- entry_submissions -----
DROP TABLE IF EXISTS `entry_submissions`;
CREATE TABLE `entry_submissions` (
  `submission_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'รหัสการส่งฟอร์ม ใช้เป็น Primary Key ของตารางการส่งคำตอบ',
  ...
  `source_type` varchar(50) NOT NULL DEFAULT 'public_form' COMMENT 'แหล่งที่มาของข้อมูล เช่น public_form, admin_created, qr_scan, import_excel',
  ...
  UNIQUE KEY `uq_entry_submissions_submission_code` (`submission_code`),
  KEY `idx_entry_submissions_form_id` (`form_id`),
  KEY `idx_entry_submissions_submitted_by_user_id` (`submitted_by_user_id`),
  KEY `idx_entry_submissions_attendance_status` (`attendance_status`),
  KEY `idx_entry_submissions_submitted_at` (`submitted_at`),
  KEY `idx_entry_submissions_deleted_at` (`deleted_at`),
  CONSTRAINT `fk_entry_submissions_form_id` FOREIGN KEY (`form_id`) REFERENCES `form_forms` (`form_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_entry_submissions_submitted_by_user_id` FOREIGN KEY (`submitted_by_user_id`) REFERENCES `auth_users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `form_field_options` (
  `option_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'รหัสตัวเลือกของฟิลด์ ใช้เป็น Primary Key ของตารางตัวเลือก',
  ...
  UNIQUE KEY `uq_form_field_options_field_id_option_value` (`field_id`,`option_value`),
  KEY `idx_form_field_options_field_id_sort_order` (`field_id`,`sort_order`),
  KEY `idx_form_field_options_is_active` (`is_active`),
  KEY `idx_form_field_options_deleted_at` (`deleted_at`),
  CONSTRAINT `fk_form_field_options_field_id` FOREIGN KEY (`field_id`) REFERENCES `form_fields` (`field_id`) ON UPDATE CASCADE
...
CREATE TABLE `form_fields` (
  `field_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'รหัสฟิลด์ของฟอร์ม ใช้เป็น Primary Key ของตารางคำถามหรือฟิลด์',
  ...
  UNIQUE KEY `uq_form_fields_form_id_field_code` (`form_id`,`field_code`),
  KEY `idx_form_fields_form_id_sort_order` (`form_id`,`sort_order`),
  KEY `idx_form_fields_field_type` (`field_type`),
  KEY `idx_form_fields_field_usage` (`field_usage`),
  KEY `idx_form_fields_is_active` (`is_active`),
  KEY `idx_form_fields_deleted_at` (`deleted_at`),
  CONSTRAINT `fk_form_fields_form_id` FOREIGN KEY (`form_id`) REFERENCES `form_forms` (`form_id`) ON UPDATE CASCADE
...
CREATE TABLE `form_forms` (
  `form_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'รหัสฟอร์ม ใช้เป็น Primary Key ของตารางฟอร์ม',
  ...
  PRIMARY KEY (`form_id`),
  UNIQUE KEY `uq_form_definitions_form_code` (`form_code`),
  UNIQUE KEY `uq_form_definitions_public_path` (`public_path`),
  KEY `idx_form_definitions_project_id` (`project_id`),
  KEY `idx_form_definitions_form_type` (`form_type`),
  KEY `idx_form_definitions_status` (`status`),
  KEY `idx_form_definitions_deleted_at` (`deleted_at`),
  KEY `idx_form_definitions_created_by_user_id` (`created_by_user_id`),
  KEY `idx_form_definitions_updated_by_user_id` (`updated_by_user_id`),
  CONSTRAINT `fk_form_definitions_created_by_user_id` FOREIGN KEY (`created_by_user_id`) REFERENCES `auth_users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_form_definitions_project_id` FOREIGN KEY (`project_id`) REFERENCES `proj_projects` (`project_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_form_definitions_updated_by_user_id` FOREIGN KEY (`updated_by_user_id`) REFERENCES `auth_users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `item_catalogs` (
  `item_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'รหัสรายการของหรือสิทธิ์รับของ ใช้เป็น Primary Key ของตารางรายการของ',
  ...
  PRIMARY KEY (`item_id`),
  UNIQUE KEY `uq_item_definitions_form_id_item_code` (`form_id`,`item_code`),
  KEY `idx_item_definitions_item_type` (`item_type`),
  KEY `idx_item_definitions_is_active` (`is_active`),
  KEY `idx_item_definitions_deleted_at` (`deleted_at`),
  KEY `idx_item_definitions_created_by_user_id` (`created_by_user_id`),
  KEY `idx_item_definitions_updated_by_user_id` (`updated_by_user_id`),
  CONSTRAINT `fk_item_definitions_created_by_user_id` FOREIGN KEY (`created_by_user_id`) REFERENCES `auth_users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_item_definitions_form_id` FOREIGN KEY (`form_id`) REFERENCES `form_forms` (`form_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_item_definitions_updated_by_user_id` FOREIGN KEY (`updated_by_user_id`) REFERENCES `auth_users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `item_claims` (
  `claim_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'รหัสสิทธิ์รับของ ใช้เป็น Primary Key ของตารางการรับของ',
  ...
  UNIQUE KEY `uq_item_claims_claim_token` (`claim_token`),
  UNIQUE KEY `uq_item_claims_submission_id_item_id` (`submission_id`,`item_id`),
  KEY `idx_item_claims_item_id` (`item_id`),
  KEY `idx_item_claims_receive_status` (`receive_status`),
  KEY `idx_item_claims_received_by_user_id` (`received_by_user_id`),
  KEY `idx_item_claims_deleted_at` (`deleted_at`),
  CONSTRAINT `fk_item_claims_item_id` FOREIGN KEY (`item_id`) REFERENCES `item_catalogs` (`item_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_item_claims_received_by_user_id` FOREIGN KEY (`received_by_user_id`) REFERENCES `auth_users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_item_claims_submission_id` FOREIGN KEY (`submission_id`) REFERENCES `entry_submissions` (`submission_id`) ON UPDATE CASCADE
...
CREATE TABLE `proj_projects` (
  `project_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'รหัสโปรเจกต์หรือเจ้าของฟอร์ม ใช้เป็น Primary Key ของตารางโปรเจกต์',
  ...
  UNIQUE KEY `uq_proj_projects_project_code` (`project_code`),
  KEY `idx_proj_projects_project_type` (`project_type`),
  KEY `idx_proj_projects_is_active` (`is_active`),
  KEY `idx_proj_projects_deleted_at` (`deleted_at`),
  KEY `idx_proj_projects_created_by_user_id` (`created_by_user_id`),
  KEY `idx_proj_projects_updated_by_user_id` (`updated_by_user_id`),
  CONSTRAINT `fk_proj_projects_created_by_user_id` FOREIGN KEY (`created_by_user_id`) REFERENCES `auth_users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_proj_projects_updated_by_user_id` FOREIGN KEY (`updated_by_user_id`) REFERENCES `auth_users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE
