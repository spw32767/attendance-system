...
export const adminDataAdapter = {
  ...
  archiveProject: (...args) => provider.archiveProject(...args),
  restoreProject: (...args) => provider.restoreProject(...args),
  ...
  archiveForm: (...args) => provider.archiveForm(...args),
  restoreForm: (...args) => provider.restoreForm(...args),
  ...
  restoreSubmission: (...args) => provider.restoreSubmission(...args),
